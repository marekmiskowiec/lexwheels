...
- local images are stored under `images/<brand>/<line>/<year>/` for year-wide lines and under `images/<brand>/<line>/<year>/<set>/` for named sets, for example `images/hot-wheels/premium/2025/fast-furious-premium-series/...`.
